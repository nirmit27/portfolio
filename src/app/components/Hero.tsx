    ...
    >
      <div className="text-center space-y-6 px-4">
        <div className="space-y-4">
          <h1 className="text-4xl font-medium md:text-7xl md:font-light text-slate-900">
            Nirmit Mishra
          </h1>
        ...
        <div className="space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="#contact"
              className="md:text-lg text-sm px-8 py-3 border border-gray-300 text-gray-700 rounded-full hover:border-gray-400 transition-colors duration-200"
            >
              Get In Touch
            </a>
          </div>
